#!/usr/bin/env python3
"""
Show ALL backtest results directly
"""
...
def show_all_results_direct():
    ...
    try:
        ...
        # Show ALL results
        print(f"\n" + "="*80)
        print("ALL STRATEGIES BY TOTAL RETURN")
        print("="*80)
        ...
        output_file = "results/all_strategies_results.csv"
        df.to_csv(output_file, index=False)
        print(f"\n✅ All {len(results)} strategies saved to: {output_file}")
